...
class AsYouTypeFormatter
{
	...
	private function getFormattingTemplate($numberPattern, $numberFormat)
	{
		...
		// Replaces each digit with character self::$digitPattern
	 ...
	 *                         are allowed, but as soon as they are encountered this method formats the number as entered
	...
	private function attemptToExtractCountryCallingCode()
	{
		...
		} else if ($newRegionCode != $this->defaultCountry) {
